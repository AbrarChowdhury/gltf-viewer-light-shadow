...
function createGUI() {
  ...
  lightFolder.add(light.shadow.camera, 'bottom', -3000, 3000).name('Shadow Bottom');
  lightFolder.add(light.shadow.camera, 'left', -3000, 3000).name('Shadow Left');
  lightFolder.add(light.shadow.camera, 'right', -3000, 3000).name('Shadow Right');
  lightFolder.add(light.shadow, 'bias', -0.01, 0.01).name('Shadow Bias');
  lightFolder.add(light.shadow.mapSize, 'width', 512, 8192).name('Shadow Map Width').onChange(updateShadowMap);
  lightFolder.add(light.shadow.mapSize, 'height', 512, 8192).name('Shadow Map Height').onChange(updateShadowMap);
